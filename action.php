<?php
	...
	else if(isset($_POST['changepwd']))
	{
		...
		$email=$_POST['email'];
		$password=$_POST['password'];
		$sql1="SELECT * from doctor where Username='".$username."' AND Emailid='".$email."'";
		$result1= mysqli_query ($conn,$sql1);
		...
		{
			$sql2="SELECT * from user where Username='".$username."' AND Emailid='".$email."'";
			...
			while($row2=mysqli_fetch_assoc($result2))
			{
				...
				echo "username and emailid mismatch";
			}
			mysqli_close($conn);
		}
	}
